...
# -----------------------------------------------------------------------------------------------------
surah_name = "Surah Al-Tur (29-49)"
file_name = "tur"
Reciter = "Reciter: Abdullah Awad Al Juhany"
verse_sajda = ""
# -----------------------------------------------------------------------------------------------------
...
for m in range(0,n):
    ...
    trans_para = textwrap.wrap(trans,width=40)
    t = ""
    an = ""
    ch = False
    for i in x:
    ...
    for i in st:
        ...
        para = textwrap.wrap(text_to_be_reshaped,width=60)
        ayah = []
        for i in para:
    ...
    W,HS = (1080,1080)
    # create an image
    out = Image.open("C:/Users/Hamza Tahir/Desktop/python/insta.png")
