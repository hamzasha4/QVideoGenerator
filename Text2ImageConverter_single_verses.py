...
for m in range(0,n):
    ...
    myFont1 = ImageFont.truetype("C:/Windows/Fonts/times.ttf", 50)
    ...
    myFont2 = ImageFont.truetype('C:/Windows/Fonts/Arial.ttf', 30)
    ...
    # --------------------------------------------------------------------------------------
    # out.show()
    out.save("C:/Users/Hamza Tahir/Desktop/shotcut_video/"+file_name+"/"+"22"+".png")
print("completed")